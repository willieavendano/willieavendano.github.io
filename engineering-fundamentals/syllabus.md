# Engineering Fundamentals — Syllabus 2026–27
...
Engineering Fundamentals is built on the PLTW **Engineering Essentials** curriculum — the on-ramp to Cushman's PLTW engineering pathway. Students are introduced to the breadth of engineering through hands-on, cross-disciplinary problems, learning the engineering design process by using it.

Using the activity-, project-, and problem-based (APB) teaching and learning pedagogy, students work individually and in teams to define problems, generate and test solutions, and communicate results. No prior engineering experience is assumed.

## Units

This course follows the official **PLTW Engineering Fundamentals** units. Each is taught through the PLTW lessons listed beneath it.

### Unit 1 — Inclined to Design

- 1.1 Engineers and Engineering
- 1.2 Systems and the Engineering Design Process
- 1.3 Product Design
- 1.4 Natural Disaster Relief Center
...
- 4.1 Urban Design
- 4.2 Maps as Models
- 4.3 The Sustainable Urban Environment
- 4.4 A Better Place
...
* PLTW Engineering Essentials Online Student Textbook (via Clever)
* PLTW Engineering Notebook
* Tinkercad (browser-based 3D design and circuits)
...
**Summative Assessments (70%)** — The goal of these assessments is to evaluate mastery of content and skills. In this course, these include (but are not limited to) builds, demos, presentations, design portfolios, and end-of-unit projects.

**Formative Assessments (25%)** — The goal of formative assessments is to gather feedback on student learning. Here students are working toward their mastery of content and skills. In this course, these include (but are not limited to) engineering notebook entries, in-class activities, sketches, guided practice, class discussions, and unannounced quizzes.
...
**Every unit closes with a build, demo, or presentation** — not a written test. Rubrics are distributed when the challenge is introduced and used to score the finished work.

**The engineering notebook** records the process: sketches, decisions, test results, and reflections. It is scored at every milestone.

**Safety certification** is required before any maker-space tool use, and is completed early in the year. It is pass/fail and must be passed to participate in fabrication work.
...
*I have read and fully understand the academic and behavioral expectations outlined in Mr. Avendano's Engineering Fundamentals syllabus. I agree to abide by these guidelines or will undergo the academic and/or disciplinary consequences.*
