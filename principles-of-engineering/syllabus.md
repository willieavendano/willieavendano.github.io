# Principles of Engineering — Syllabus 2026–27
...
PLTW Principles of Engineering (POE) is a high school engineering course in the PLTW Engineering pathway. Students explore a broad range of engineering topics — mechanical design, robotics, energy systems, and infrastructure — applying the engineering design process to open-ended problems using the activity-, project-, and problem-based (APB) teaching and learning pedagogy.

Working in collaborative teams, students design, build, test, and document solutions. They apply mathematics and science to engineering problems, develop competency in professional practices including project management and peer review, and consider sustainability and societal impact as part of responsible engineering design.

## Units

This course follows the official **PLTW Principles of Engineering** units. Each is taught through the PLTW lessons listed beneath it.

### Unit 0 — Introduction to Product Design and Development

- 0.1 Engineering Design Process
- 0.2 Collaborative Modeling and Modern Product Design
- 0.3 Material Choice and Testing
- 0.4 Designing a Shoe for You

### Unit 1 — Mechanical Design

- 1.1 Simple and Compound Machines
- 1.2 Mechanisms
- 1.3 Agricultural Solutions

### Unit 2 — Applications of Robotics

- 2.1 Introduction to Robotics
- 2.2 Robots in Action
- 2.3 Artificial Intelligence
- 2.4 An Electronic Ensemble

### Unit 3 — Energy in Action

- 3.1 Electrical Circuits
- 3.2 Fluid Power
- 3.3 Kinematics
- 3.4 Integration of Circuits, Fluid Power, and Kinematics

### Unit 4 — Designing Infrastructure and Developing Sustainability

- 4.1 Statics
- 4.2 Renewable Energy
- 4.3 Transportation
- 4.4 Infrastructure Redesign
...
* VEX robotics platform and course-issued electronics kits
...
**Summative Assessments (70%)** — The goal of these assessments is to evaluate mastery of content and skills. In this course, these include (but are not limited to) builds, demos, competitions, design reports, presentations, and the written midterm.

**Formative Assessments (25%)** — The goal of formative assessments is to gather feedback on student learning. Here students are working toward their mastery of content and skills. In this course, these include (but are not limited to) engineering notebook entries, in-class activities, calculation sets, lab data collection, class discussions, and unannounced quizzes.
...
**Builds are the assessments** in this course. Every unit closes with a milestone you can point at — a mechanism demo, a load test, an automation challenge, an accuracy competition. Rubrics are distributed when the challenge is introduced and used to score the finished work.

**The engineering notebook** is a graded, ongoing record: sketches, calculations, test data, and design decisions, dated and in ink. It is scored at every milestone and audited at midterm.

**The written midterm** is the one traditional written exam in this course. Everything else is assessed through what you built and how you documented it.
...
*I have read and fully understand the academic and behavioral expectations outlined in Mr. Avendano's Principles of Engineering syllabus. I agree to abide by these guidelines or will undergo the academic and/or disciplinary consequences.*
