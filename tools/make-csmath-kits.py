...
MIAMI_JOBS = [
    ("Junior software developer", 82000),
    ("Marketing coordinator", 49000),
    ("Registered nurse", 79000),
    ("Civil engineer (EIT)", 72000),
    ("Paralegal", 54000),
    ("Financial analyst", 74000),
    ("Teacher, first year", 48500),
    ("Graphic designer", 47000),
    ("Mechanical engineer", 75000),
    ("Sales representative (base + commission)", 42000),
    ("Lab technician", 44000),
    ("Architectural designer", 59000),
    ("Investment banking analyst", 110000),
    ("Air traffic controller trainee", 68000),
    ("Physical therapist (DPT)", 92000),
    ("Social worker (MSW)", 51000),
    ("Data scientist", 105000),
    ("Restaurant assistant manager", 52000),
    ("Journalist / content producer", 41000),
    ("Dental hygienist", 81000),
    ("HVAC technician (licensed)", 63000),
    ("Nonprofit program coordinator", 43000),
    ("Commercial real estate analyst", 76000),
    ("Pharmacist (PharmD)", 128000),
]
