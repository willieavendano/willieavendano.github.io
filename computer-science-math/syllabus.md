# Computer Science Math — Syllabus 2026–27
...
### Unit L — The Casino Lab

- Probability and expected value
- RAND simulations and the law of large numbers
- The house edge

### Unit 4 — Cornerstone IV — Stocks: Forecasting & Management

- Time series and moving averages
- Volatility and risk
- Monte Carlo simulation

### Unit 5 — Cornerstone V — The Lemonade Stand

- Simulated demand and pricing
- Costs and break-even
- Sensitivity analysis

### Unit C — Capstone — The Pop-Up Forecast
...
**Summative Assessments (70%)** — The goal of these assessments is to evaluate mastery of content and skills. In this course, these include (but are not limited to) cornerstone projects, their presentations, and the year-end capstone pitch.

**Formative Assessments (25%)** — The goal of formative assessments is to gather feedback on student learning. Here students are working toward their mastery of content and skills. In this course, these include (but are not limited to) in-class model building, guided spreadsheet exercises, skills checks, class discussions, and unannounced quizzes.
