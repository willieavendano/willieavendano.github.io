# Physics — Syllabus 2026–27

**Mr. Willie Avendano**  
[wavendano@cushmanschool.org](mailto:wavendano@cushmanschool.org)  
Room 502/3  

**Class meets:** Monday, Period 2 (8:53–9:37) · Tuesday & Thursday, Block 2 (9:36–10:56)
...
A first course in physics built around measurement, modeling, and laboratory work. Students develop a shared problem-solving protocol and apply it across kinematics, forces, energy, momentum, rotation, simple harmonic motion, waves, and circuits.

The course is anchored by a sequence of five formal laboratory reports with steadily decreasing scaffolding, ending with a student-designed investigation. The emphasis throughout is on reasoning from evidence and communicating results honestly.

## Units

### Unit 0 — The Physicist's Toolkit

- Units, notation, and dimensional analysis
...
- Work and power
- Conservation of energy — Lab Report III

### Unit 5 — Momentum

- Impulse and momentum
- Collisions — Lab Report IV
...
* Course-issued readings and problem sets
* Laboratory notebook
...
**Summative Assessments (70%)** — The goal of these assessments is to evaluate mastery of content and skills. In this course, these include (but are not limited to) unit tests, formal laboratory reports, the student-designed investigation, and the year-end capstone.

**Formative Assessments (25%)** — The goal of formative assessments is to gather feedback on student learning. Here students are working toward their mastery of content and skills. In this course, these include (but are not limited to) problem sets, in-class practice, laboratory activities, class discussions, and unannounced quizzes.
...
**The five formal lab reports** are the backbone of the course, and the scaffolding fades across them: the kinematics cart lab is heavily guided, the friction lab semi-guided, the energy lab your first fully independent report, then collisions, and finally a pendulum investigation you design yourself.

**Unit tests** consist of conceptual questions, free response, and calculation-based problems. No extra time will be given unless there is approved accommodation, as tests are designed to be completed within the designated time.

**Honest numbers** are a graded expectation. Report the precision your measurement actually supports, distinguish exact values from approximations, and state your uncertainty. A right answer with dishonest significant figures is not a right answer.
...
*I have read and fully understand the academic and behavioral expectations outlined in Mr. Avendano's Physics syllabus. I agree to abide by these guidelines or will undergo the academic and/or disciplinary consequences.*
